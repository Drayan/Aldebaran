...
#ifndef _WIN64
#error "A 64-bits architecture is required for Aldebaran to be compiled."
#endif
...
// Catch anything to caught by the above.
#define APLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
// Posix
#define APLATFORM_POSIX
...
#define ACLAMP(value, min, max) (value <= min) ? min : (value >= max) ? max : value;
